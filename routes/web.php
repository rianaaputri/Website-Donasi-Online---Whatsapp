...
Route::middleware('guest')->group(function () {
    ...
    // OTP Creator
    Route::get('/otp/verify', [CampaignCreatorRegisterController::class, 'showOtpForm'])->name('verify.otp.form');
    Route::post('/otp/verify', [CampaignCreatorRegisterController::class, 'verifyOtp'])->name('verify.otp');
    Route::post('/otp/resend', [CampaignCreatorRegisterController::class, 'resendOtp'])->name('resend.otp');
